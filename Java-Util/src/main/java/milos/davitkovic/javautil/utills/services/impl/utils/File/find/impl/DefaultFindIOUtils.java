package milos.davitkovic.javautil.utills.services.impl.utils.File.find.impl;
...
@Slf4j
@UtilClass
public class DefaultFindIOUtils implements FindIOUtils {
    ...
    public String listFilesInDefaultFolder() {
        try (Stream<Path> stream = Files.list(Paths.get(""))) {
            ...
            log.error("ERROR-LIST-FILES-IN-DEFAULT-FOLDER, IOException {}", e.getMessage());
        }
    ...
    public String listFilesInSpecificFolder(final String folderName) {
        try (Stream<Path> stream = Files.list(Paths.get(folderName))) {
            ...
            log.error("ERROR-LIST-FILES-IN-SPECIFIC-FOLDER, IOException {}", e.getMessage());
            return StringUtils.EMPTY;
        }
    }
